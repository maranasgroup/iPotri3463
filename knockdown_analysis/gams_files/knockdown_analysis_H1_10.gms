...
$include "impose_LBs_H1.txt"

	imp_UB(j_kd)	upper bound to impose on the candidate
$include "impose_UBs_H1.txt"
...
SCALAR
	...
	leaf_g_H1		/0.00096003495/
	stem_g_H1		/0.00096003495/
	root_g_H1		/0.00284249568/
	beta
	stem_frac	
	root_frac
	leaf_frac
...
file RESULT /knockdown_result_H1_10.txt/;
put RESULT;
...
LOOP(j_kd1,
	...
	if(imp_LB(j_kd1)<=imp_UB(j_kd1),
		...
		v.lo(j_kd1) = imp_LB(j_kd1);
		v.up(j_kd1) = imp_UB(j_kd1);
		...
		stem_frac = v.l('RXN_BiomassRxn__S___DARK') / stem_g_H1;
		leaf_frac = v.l('RXN_BiomassRxn__L___DARK') / leaf_g_H1;
		root_frac = v.l('RXN_BiomassRxn__R___DARK') / root_g_H1;
