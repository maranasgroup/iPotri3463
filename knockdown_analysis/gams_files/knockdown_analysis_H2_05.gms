...
SCALAR
	...
	leaf_g_H2		/0.0001422273999999948/
	stem_g_H2		/0.0001422274/
	root_g_H2		/0.00275366769/
	beta
	stem_frac
	root_frac
	leaf_frac
...
file RESULT /knockdown_result_H2_05.txt/;
put RESULT;
...
LOOP(j_kd1,
	...
	if(imp_LB(j_kd1)<=imp_UB(j_kd1),
		...
		stem_frac = v.l('RXN_BiomassRxn__S___DARK') / stem_g_H2;
		leaf_frac = v.l('RXN_BiomassRxn__L___DARK') / leaf_g_H2;
		root_frac = v.l('RXN_BiomassRxn__R___DARK') / root_g_H2;

		put j_kd1.tl:0:65,system.tab,v.lo(j_kd1):0:8,system.tab,v.lo(j_kd1):0:8,system.tab,v.l('RXN_BiomassRxn__S___DARK'):0:8,system.tab,v.l('RXN_BiomassRxn__L___DARK'):0:8,system.tab,v.l('RXN_BiomassRxn__R___DARK'):0:8,system.tab,stem_frac,system.tab,leaf_frac,system.tab,root_frac,system.tab,KNOCKDOWN.Modelstat,system.tab,KNOCKDOWN.Solvestat;

	else

		put j_kd1.tl:0:65,system.tab,v.lo(j_kd1):0:8,system.tab,v.lo(j_kd1):0:8,system.tab,0,system.tab,0,system.tab,0,system.tab,0,system.tab,0,system.tab,0,system.tab,"problem",system.tab,"problem";
