...
$include "LB_C.txt"
	...
	UB(j)			upper bounds of reactions
$include "UB_C.txt"
...
eqn21..							v('RXN_RIBULOSE_BISPHOSPHATE_CARBOXYLASE_RXN_p__L___LIGHT') + 4 * v('RXN_RXN_961_p__L___LIGHT') =e= 0;

*****************************************************************************

*note: all the puclose and append stuff allows for real-time writing
file RESULT /FVA_result_C.txt/;
put RESULT;
